  ...
  */
  ...
  /**
  * MySqlFunctionsClass raggruppa tutte le funzioni rivolte
      ...
      function getDailyConnectionAsJSON($mese,$anno) {
        ...
        */
        function getMontlyConnectionAsJSON($anno) {
          ...
          function getConnectionYearsArrayAsJSON() {
            $query = "SELECT DISTINCT year(when_registered) as anno " .
            " FROM scuola.utenti_logger WHERE msg_type = 'LOGIN_SUCCESS'" .
            " ORDER BY when_registered";
            if(
            mysql_connect("localhost","root","myzconun")){
            ...
            function getConnectionMonthsArrayAsJSON($anno) {
              $query = "SELECT DISTINCT month(when_registered) as mese " .
              " FROM scuola.utenti_logger WHERE msg_type = 'LOGIN_SUCCESS'" .
              " AND year(when_registered) = ".$anno.
              " GROUP BY month(when_registered)" .
              " ORDER BY when_registered";
              ...
              mysql_connect("localhost","root","myzconun")){
                ...
                */
                function getDailyConnection() {
                  ...
                  /**
                  * Conta le connessioni, ovvero i log = LOGIN_SUCCESS,
                  * effettuate divise per mese per popolare
                  * il grafico nella index.php
                  * @return array
                  */
                  ...
                  */
                  ...
                  /************************************************/
                  /********* RICHIESTA DI RINNOVO PASSWORD ********/
                  /************************************************/

                  /**
                  *
                  * Enter description here ...
                  * TABELLA: scuola.change_password_request
                  * Controlla se esiste già, in tabella, una richiesta di
                  * rinnovo password
